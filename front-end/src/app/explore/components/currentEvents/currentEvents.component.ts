            ...
            response => {
                if(!response.events){
                    ...
                    for(var i=0; i < this.events.length; i++){
                        this.events[i].hour = this.events[i].hour.substr(0,5);
                        //console.log(this.events[i].hour);
                    }
        ...
        this._eventService.getEvent(id).subscribe(
            response => {
                if(!response.event){
                    ...
                    this.view_event.hour = this.view_event.hour.substr(0,5);
