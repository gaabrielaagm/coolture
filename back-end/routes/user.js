...
api.put('/pw-update/:id', md_auth.ensureAuth, UserController.changePw);
api.put('/upload-image-user/:id', md_upload, UserController.uploadImage);
//api.post('/upload-image-user/:id', [md_auth.ensureAuth, md_upload], UserController.uploadImage);
api.get('/get-image-user/:imageFile', md_upload, UserController.getImageFile);
