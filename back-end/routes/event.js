...
api.get('/allEvents', EventController.getAllEvents);
api.put('/event/:id', [md_auth.ensureAuth, md_admin.isAdmin], EventController.updateEvent);
api.put('/eventsClasifications', EventController.getEventsByClasifications);
...
api.put('/image-event/:id', md_upload, EventController.uploadImage);
